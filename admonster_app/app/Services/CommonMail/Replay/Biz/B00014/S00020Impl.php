...
namespace App\Services\CommonMail\Replay\Biz\B00014;
...
class S00020Impl extends GenericImpl
{
    ...
    public function getDefaultBody(int $task_id)
    {
        ...
        // 获取模板
        $template_config_array = \Config::get("biz.b00014.MAIL_CONFIG.s00020.MAIL_REPLAY_BODY_TEMPLATE");
