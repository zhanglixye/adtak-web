...
<!--                                <div style="font-size: 16px">{{title?unKnowText:unKnowText_AP}}</div>-->
                                <div style="font-size: 16px">「不備・不明理由を選択してください。（複数可）」</div>
                            </div>
                ...
                <v-card-text class="pt-3 pb-0">
                    <div class="flex_column check_dia_bo pl-3 pr-3">
                        <v-checkbox v-model="unKnowCheckboxBoolean1" label="会計年月記入なし"></v-checkbox>
                        ...
                        <v-checkbox v-model="unKnowCheckboxBoolean5" class="mt-0" label="明細合計と合計金額が不一致"></v-checkbox>
                        <v-checkbox v-model="unKnowCheckboxBoolean6" class="mt-0" label="APシートと常駐シートの両方に記載あり"></v-checkbox>
                        <v-checkbox v-model="unKnowCheckboxBoolean7" class="mt-0" label="その他"></v-checkbox>
                        <v-textarea
                                clearable
                                clear-icon="cancel"
                                label="コメント"
...
export default {
    ...
    data(){
        return {
            dialog: false,
            firstName:'高田浩敏',
            unKnowText:'『★交通費(常駐)メール』シート　不備・不明理由を選択して下さい。（複数可）のみ',
            unKnowText_AP:'『★交通費(AP)メール』シート　不備・不明理由を選択して下さい。（複数可）のみ',
            unKnowCheckboxBoolean1:false,
