                        ...
                        <v-layout row wrap>
                            ...
                            <v-flex sm6 md4>
                                <v-layout column wrap>
                                    <v-flex md12 pr-3>
                                        <v-text-field
                                            v-model="searchParams.approver"
                                            prepend-icon="assignment_ind"
                                            hide-details
                                            :label="$t('list.search_condition.approver')"
                                            :placeholder="$t('list.search_condition.partial_search')"
                                            @keyup.enter="search"
                                        ></v-text-field>
                                    </v-flex>
...
const APPROVAL_STATUSES = [
    ...
    { text: Vue.i18n.translate('approvals.list.approval_status.done'), value: _const.APPROVAL_STATUS.DONE },
];
...
export default {
    data: () => ({
        ...
        searchParams: {
            ...
            approver: store.state.searchParams.approver,
    ...
    methods: {
        ...
        setSearchParams () {
            ...
            this.searchParams.approver = store.state.searchParams.approver
