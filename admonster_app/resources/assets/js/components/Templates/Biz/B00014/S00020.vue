<template>
    <div>
        ...
        ></email-deal>
        <!-- 经费承认-->
        <read-deal-recognize :checkboxListMade="!madeAGParent" ref="readRecognize" :axiosFormData="axiosFormData" style="overflow: hidden auto;" @emailSend="emailSend" :data="readRecoginceData" @changeEmail="changeEmail" v-show="!flag_business_rec"></read-deal-recognize>
...
export default {
    ...
    methods:{
        ...
        init(){
            ...
            //不明状态
            if (result == 1){
                this.$refs.emailDeal.$data.finishAg = true;
                //调转到承认模块
                ...
                let unKnowText = '不備/不明アリで処理されました。ご確認ください<br>' + initContent.G00000_27.C00200_34;
