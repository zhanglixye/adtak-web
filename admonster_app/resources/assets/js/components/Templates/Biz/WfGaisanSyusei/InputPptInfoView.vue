                ...
                <v-layout row wrap>
                    <v-flex xs12 mb-2>
                        <h5 class="headline ma-0">
                            {{ $t('biz.wf_gaisan_syusei.input_ppt_info.h1') }}
                        </h5>
                    </v-flex>
                    <v-flex xs12>
                    ...
                    <v-flex xs12 mb-4 v-if="resData">
                        <master-sheet :master-data="resData.master_data"></master-sheet>
                    </v-flex>
                    <v-flex xs12 sm6 md5 v-if="resData">
                        <ppt-info-help :res-data="resData"></ppt-info-help>
                    </v-flex>
...
import MasterSheet from '../../../Organisms/Biz/WfGaisanSyusei/InputPptInfo/MasterSheet.vue'
import PptInfoHelp from '../../../Organisms/Biz/WfGaisanSyusei/InputPptInfo/PptInfoHelp.vue'
import Steps from '../../../Organisms/Biz/WfGaisanSyusei/InputPptInfo/Steps.vue'
...
export default {
    ...
    methods:{
        getData: function(type) {
            this.loading = true
            axios.get('/api/biz/wf_gaisan_syusei/input_ppt_info/' + this.requestWorkId + '/' + this.taskId + '/create')
                .then((res) => {
                    if (type == 'initial') {
                        // 初回ロード時
