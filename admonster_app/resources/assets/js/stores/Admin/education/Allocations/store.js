...
const initialState = {
    ...
    showHeaders:[
        ...
        { text: Vue.i18n.translate('list.column.worker') + Vue.i18n.translate('list.column.has_image'), value: 'worker_ids', align: 'center', width: '100' },
        { text: Vue.i18n.translate('list.column.allocator') + Vue.i18n.translate('list.column.has_image'), value: 'allocator_id', align: 'center', width: '100' },
    ...
    hiddenHeaders:[
        ...
        { text: Vue.i18n.translate('list.column.worker') + Vue.i18n.translate('list.column.no_image'), value: 'worker_ids_no_image', align: 'center', width: '100' },
        { text: Vue.i18n.translate('list.column.allocator') + Vue.i18n.translate('list.column.no_image'), value: 'allocator_id_no_image', align: 'center', width: '100' },
...
const store = new Vuex.Store({
    ...
    plugins: [
        createPersistedState({
            key: 'educationAllocationListSearchParams',
            paths: ['searchParams'],
