...
const initialState = {
    searchParams: {
        ...
        step_name: '',
        approval_status: [
            { text: Vue.i18n.translate('approvals.list.approval_status.none'), value: _const.APPROVAL_STATUS.NONE },
            { text: Vue.i18n.translate('approvals.list.approval_status.on'), value: _const.APPROVAL_STATUS.ON },
        ],
    ...
    showHeaders:[
        ...
        { text: Vue.i18n.translate('list.column.status'), value: 'approval_status', align: 'center', width: '100' },
    ...
    hiddenHeaders:[
        ...
        { text: Vue.i18n.translate('list.column.approval_conditions'), value: 'is_auto', align: 'center', width: '100' },
        { text: Vue.i18n.translate('list.column.approver') + Vue.i18n.translate('list.column.has_image'), value: 'approver_id', align: 'center', width: '100', textForSetting: Vue.i18n.translate('list.column.approver') },
        { text: Vue.i18n.translate('list.column.approver') + Vue.i18n.translate('list.column.no_image'), value: 'approver_id_no_image', align: 'center', width: '100', textForSetting: Vue.i18n.translate('list.column.approver') },
        { text: Vue.i18n.translate('list.column.approval_time'), value: 'approval_time', align: 'center', width: '100' },
