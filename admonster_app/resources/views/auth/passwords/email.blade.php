    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            <div>
                ...
                <p class="reset-pass-box-msg">ご登録済みのメールアドレスを入力してください。<br>パスワードリセット用のリンクをお送りします。</p>
            </div>
        ...
        <div>
                <p class="reset-pass-box-msg" style="padding-top:1em;padding-left:1em;text-indent:-1em;">
                    {{-- <i class="fa fa-fw fa-heart-o"></i> --}}
                    <span>※&nbsp;&nbsp;</span><span>1時間経過してもメールが届かない場合は、メールアドレスが間違っている可能性があります。再送信いただいても届かない際は<a href="#">こちら</a>からお問い合わせください。</span>
                </p>
            </div>
    <!-- /.login-box-body -->
    </div>
