...
class CreateCommonMailChecklistGroupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('common_mail_checklist_groups', function (Blueprint $table) {
        ...
        // テーブルコメント定義
        DB::statement("ALTER TABLE common_mail_checklist_groups COMMENT 'メール共通処理のチェックリストグループ'");
    }
    ...
    {
        Schema::dropIfExists('common_mail_checklist_groups');
    }
}
