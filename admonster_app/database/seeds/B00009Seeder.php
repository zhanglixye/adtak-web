...
class B00009Seeder extends Seeder
{
    /**
     * Run the database seeds.
     * Command: php artisan db:seed --class=B00009Seeder
     *
     * @return void
     */
    public function run()
    {
        ...
        $steps = [
            [
                ...
                'item_configs' => [
                    ...
                    "checklist/G00000_27/G00000_33/1/items/3" => [
                        "label" => null,
                        "type" => 400,
                        "sort" => 105,
                        "values" => [
        ...
        $common_mail = [
            ...
            $steps[0]['id'] => [
                'condition_cd' => 1,
                'title' => "不備・不明なしの場合",
                'content' => "<p><br></p><p>------------------ Original ------------------</p><p>&gt;From: #{before_mail_from}</p><p>&gt;Date:#{before_mail_date}</p><p>&gt;Subject:#{before_mail_subject}</p><p>&gt;To:#{before_mail_to}</p><p>&gt;CC:#{before_mail_cc}</p><p>#{before_mail_body}</p>",
                'checklist' => [
                    [
                        'content' => '作業チェック内容１',
                        'items' => [
                            ['component_type' => 1, 'content' => '対応件数'],
                        ],
                    ],
                    [
                        'content' => '作業チェック内容２',
                        'items' => [
                            ['component_type' => 0, 'content' => '宛先に間違いありません'],
                            ['component_type' => 0, 'content' => '件名に間違いありません'],
                            ['component_type' => 0, 'content' => 'メール内容に間違いありません'],
                            ['component_type' => 0, 'content' => '添付fileに間違いありません'],
                        ]
                    ]
                ]
            ],
