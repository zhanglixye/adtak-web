...
class B00007Seeder extends Seeder
{
    /**
     * Run the database seeds.
     * Command: php artisan db:seed --class=B00007Seeder
     *
     * @return void
     */
    public function run()
    {
        ...
        $business = [
            'id' => 7,
            'name' => 'Abbey素材確認業務',
            'description' => 'メールに添付された広告素材をYAHOO提供のチェックツール「Abbey」で確認する業務',
        ...
        $steps = [
            [
                ...
                'deadline_limit' => 1,
                'end_criteria' => 0,
                'is_send_task_req_mail' => \Config::get('const.FLG.INACTIVE'),  // 本番はACTIVE
